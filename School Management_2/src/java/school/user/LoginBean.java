...
import school.util.HashingPassword;
...
public class LoginBean implements java.io.Serializable {
  ...
  public void setPassword(String password) {
      /**
       * if password is empty or null no need to call hasingPassword function
       */
      try {
         if(password == null || password.isEmpty()){
             this.password = password;
         } else {
             this.password = HashingPassword.hashingPassword(password);
         }
    ...
    ResultSet rs = null;
     /*
      ...
      if(DBConnect.getConnection() == null){
           FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", "Failed to connect database. Please contact your administration.");
